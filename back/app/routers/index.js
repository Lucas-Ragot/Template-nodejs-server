...
router
     ...
     * @tags Pro
     * @param {number} idPro.path.required - pro identifier
     * @return {Pro} 200 - success response - application/json
...
/**
 * DELETE /api/pro/{idPro}/tatouages/{idTatoo}
 * @summary Delete one tatoo to one pro
 * @tags Pro - Tatoo
 * @param {number} idPro.path.required - pro identifier
 * @param {number} idTatoo.path.required - tatoo identifier
 * @return {Tatoo} 200 - success response - application/json
 * @return {ApiError} 400 - Bad request response - application/json
 * @return {ApiError} 404 - Pro not found - application/json
...
router
    ...
    /**
     * PATCH /api/pro/{idPro}/rdv/{idRdv}
     * @summary Modify an appointment
     * @tags Pro - Appointment
     * @param {number} idPro.path.required - pro identifier
     * @param {number} idRdv.path.required - appointment identifier
     * @param {InputAppointment} request.body.required - appointment infos
     * @return {Appointment} 200 - success response - application/json
     * @return {ApiError} 400 - Bad request response - application/json
     * @return {ApiError} 404 - Pro not found - application/json
    ...
    /**
     * DELETE /api/pro/{idPro}/rdv/{idRdv}
...
router
    ...
    /**
     * GET /api/consumer/{idConsumer}
     * @summary Get a consumer
     * @tags Consumer
     * @param {number} idConsumer.path.required - consumer identifier
    ...
    /**
     * DELETE /api/consumer/{idConsumer}
...
router
    .route('/api/projet/:id')
    /**
     * GET /api/projet/{idProjet}
     * @summary Get a project
     * @tags Project
     * @param {number} idProjet.path.required - project identifier
...
/**
 * GET /api/consumer/{idConsumer}/projet
